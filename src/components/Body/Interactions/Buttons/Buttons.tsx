...
export default function RemoveButton() {
  ...
  const addAColumn = () => {
    const availableTeams = allTeams.filter((team) => !teamsSelected.includes(team));
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
      ...
      >
        <div>
          <i className="fa fa-trash" style={{ color: '#ffffff', padding: '0.1rem' }}></i>
          <i className="fa fa-list" style={{ color: '#ffffff', padding: '0.1rem' }}></i>
        </div>
      </button>
      ...
      >
        <div>
          <i className="fa fa-plus" style={{ color: '#000000', padding: '0.1rem' }}></i>
          <i className="fa fa-columns" style={{ color: '#000000', padding: '0.1rem' }}></i>
        </div>
      </button>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <i className="fa fa-minus" style={{ color: '#ffffff', padding: '0.1rem' }}></i>
          <i className="fa fa-columns" style={{ color: '#ffffff', padding: '0.1rem' }}></i>
        </div>
      </button>
    </div>
  );
